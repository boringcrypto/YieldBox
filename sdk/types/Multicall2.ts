...
import { TypedEventFilter, TypedEvent, TypedListener, OnEvent } from "../../web3/classes/types/common"
...
export interface Multicall2 extends BaseContract {
    ...
    functions: {
        aggregate(calls: Multicall2.CallStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
    ...
    blockAndAggregate(calls: Multicall2.CallStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
    ...
    estimateGas: {
        aggregate(calls: Multicall2.CallStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>

        blockAndAggregate(calls: Multicall2.CallStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    populateTransaction: {
        aggregate(calls: Multicall2.CallStruct[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>
