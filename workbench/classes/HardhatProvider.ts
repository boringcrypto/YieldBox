...
class HardhatProvider {
    ...
    constructor() {
        ...
        this.deployer = ethers.Wallet.fromMnemonic(mnemonic, "m/44'/60'/0'/0/0").connect(this.provider) as NamedWallet
        this.deployer.name = "Deployer"
        this.alice = ethers.Wallet.fromMnemonic(mnemonic, "m/44'/60'/0'/0/1").connect(this.provider) as NamedWallet
        this.alice.name = "Alice"
        this.bob = ethers.Wallet.fromMnemonic(mnemonic, "m/44'/60'/0'/0/2").connect(this.provider) as NamedWallet
        this.bob.name = "Bob"
        this.carol = ethers.Wallet.fromMnemonic(mnemonic, "m/44'/60'/0'/0/3").connect(this.provider) as NamedWallet
        this.carol.name = "Carol"
        this.dirk = ethers.Wallet.fromMnemonic(mnemonic, "m/44'/60'/0'/0/4").connect(this.provider) as NamedWallet
        this.dirk.name = "Dirk"
        this.erin = ethers.Wallet.fromMnemonic(mnemonic, "m/44'/60'/0'/0/5").connect(this.provider) as NamedWallet
        this.erin.name = "Erin"
        this.fred = ethers.Wallet.fromMnemonic(mnemonic, "m/44'/60'/0'/0/6").connect(this.provider) as NamedWallet
        this.fred.name = "Fred"
